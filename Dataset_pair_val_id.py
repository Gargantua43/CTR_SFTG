...
class MyDatasetVal(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 读pair文件中id一列
        pair_id = self.df_Pair['SFTG_Val_id'][index]
...
# my_dataset = MyDatasetVal("./SFTG_CTR_label_pair_val_id.csv")
