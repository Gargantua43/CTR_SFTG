...
class MyDatasetTrain(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 读pair文件中id一列
        pair_id = self.df_Pair['SFTG_Train_id'][index]
...
# my_dataset = MyDatasetTrain("./SFTG_CTR_label_pair_train_id_shuffle.csv")
# train_loader = DataLoader(dataset=my_dataset, batch_size=2, shuffle=True)
